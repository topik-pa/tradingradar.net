...
class MarketsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create market" do
    assert_difference('Market.count') do
      post markets_url, params: { market: { name: @market.name, value: @market.value, variation: @market.variation } }
    end
  ...
  test "should update market" do
    patch market_url(@market), params: { market: { name: @market.name, value: @market.value, variation: @market.variation } }
