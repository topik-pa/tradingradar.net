class AnalysesController < ApplicationController
  ...
  private
    ...
    def analysis_params
      params.require(:analysis).permit(:isin, :borsaItalianaSupport, :borsaItalianaResistance, :borsaItalianaFTA, :xxivOreSupport, :xxivOreResistance, :xxivOreShortTrend, :xxivOreFTAIndex, :xxivOreRSI, :xxivOreRSIDiv, :repubblicaSupport, :repubblicaResistance, :investingDotComRating)
    end
end
