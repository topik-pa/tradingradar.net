class AnalysesController < ApplicationController
  ...
  private
    ...
    def analysis_params
      params.require(:analysis).permit(:isin, :borsa_italiana_support, :borsa_italiana_resistance, :borsa_italiana_fta, :xxivore_support, :xxivore_resistance, :xxivore_shorttrend, :xxivore_ftaindex, :xxivore_rsi, :xxivore_rsidiv, :repubblica_support, :repubblica_resistance, :milano_finanza_risk, :milano_finanza_rating, :investing_dotcomrating)
    end
end
